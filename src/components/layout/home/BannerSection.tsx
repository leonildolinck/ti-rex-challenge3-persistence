...
const BannerSection: React.FC = () => {
  return (
    <section className="lg:h-[612px] sm:h-full overflow-hidden relative font-poppins">
      ...
      />
      <div className="lg:absolute sm:relative lg:top-20 sm:top-0 lg:right-[53px] sm:right-[0px] transform bg-[#FFF3E3] lg:w-[643px] sm:w-full lg:h-[443px] sm:h-[420px] z-10 lg:p-10 sm:p-2">
