...
import { removeProductFromCart } from "../components/cart/actions";
...
const CartItem: React.FC = ({ product }) => {
  ...
  return (
    <div className="flex flex-row text-poppins ml-6 mt-6 mr-10 justify-between items-center">
      <img src={product.image} alt="" className="h-[110px] w-[110px] rounded-[10px]" />
      ...
      <button onClick={handleRemoveClick}>
        <img src="https://desafio-3.s3.us-east-1.amazonaws.com/excluir-item.svg" alt="" className="h-5 w-5"/>
      </button>
    </div>
  );
};
